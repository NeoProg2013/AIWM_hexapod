    ...
    {
        {
            ...
            .motion_time = MTIME_MIN_VALUE, .time_stop = MTIME_MAX_VALUE, .time_update = MTIME_NO_UPDATE, .speed = 20
        },
        {   // Dummy sequence for delay
            {{-140, -15, 83}, {-162, -15, 0}, {-140, -15, -83}, {140, -15, 83}, {162, -15, 0}, {140, -15, -83}},
            { TRAJ_XYZ_LINEAR, TRAJ_XYZ_LINEAR, TRAJ_XYZ_LINEAR, TRAJ_XYZ_LINEAR, TRAJ_XYZ_LINEAR, TRAJ_XYZ_LINEAR},
            { TIME_DIR_DIRECT, TIME_DIR_DIRECT, TIME_DIR_DIRECT, TIME_DIR_DIRECT, TIME_DIR_DIRECT, TIME_DIR_DIRECT },
            .motion_time = MTIME_MIN_VALUE, .time_stop = MTIME_MAX_VALUE, .time_update = MTIME_NO_UPDATE, .speed = 40
        },
        {
    ...
    {
        {
            ...
            { TRAJ_XYZ_LINEAR, TRAJ_XYZ_LINEAR, TRAJ_XYZ_LINEAR, TRAJ_XYZ_LINEAR, TRAJ_XYZ_LINEAR, TRAJ_XYZ_LINEAR},
            { TIME_DIR_DIRECT, TIME_DIR_DIRECT, TIME_DIR_DIRECT, TIME_DIR_DIRECT, TIME_DIR_DIRECT, TIME_DIR_DIRECT },
            .motion_time = MTIME_MIN_VALUE, .time_stop = MTIME_MAX_VALUE, .time_update = MTIME_NO_UPDATE, .speed = 60
        },
        {   // Dummy sequence for delay
            {{-140, -15, 83}, {-162, -15, 0}, {-140, -15, -83}, {140, -15, 83}, {162, -15, 0}, {140, -15, -83}},
            { TRAJ_XYZ_LINEAR, TRAJ_XYZ_LINEAR, TRAJ_XYZ_LINEAR, TRAJ_XYZ_LINEAR, TRAJ_XYZ_LINEAR, TRAJ_XYZ_LINEAR},
        ...
        },
        {
            ...
            { TRAJ_XYZ_LINEAR, TRAJ_XYZ_LINEAR, TRAJ_XYZ_LINEAR, TRAJ_XYZ_LINEAR, TRAJ_XYZ_LINEAR, TRAJ_XYZ_LINEAR},
            { TIME_DIR_DIRECT, TIME_DIR_DIRECT, TIME_DIR_DIRECT, TIME_DIR_DIRECT, TIME_DIR_DIRECT, TIME_DIR_DIRECT },
            .motion_time = MTIME_MIN_VALUE, .time_stop = MTIME_MAX_VALUE, .time_update = MTIME_NO_UPDATE, .speed = 100
        },
        {    // Up 0, 2, 4 legs
...
static const sequence_info_t sequence_push_pull = {
     ...
     
    {
        ...
        {
            {0}, // Destination points is not use for TRAJ_XZ_ADV_Y_CONST
            { TRAJ_XZ_ADV_Y_CONST, TRAJ_XZ_ADV_Y_CONST, TRAJ_XZ_ADV_Y_CONST, TRAJ_XZ_ADV_Y_CONST, TRAJ_XZ_ADV_Y_CONST, TRAJ_XZ_ADV_Y_CONST},
            { TIME_DIR_DIRECT, TIME_DIR_DIRECT, TIME_DIR_DIRECT, TIME_DIR_DIRECT, TIME_DIR_DIRECT, TIME_DIR_DIRECT },
            {{-115, LIMB_DOWN_Y, 70}, {-135, LIMB_DOWN_Y, 0}, {-115, LIMB_DOWN_Y, -70}, {115, LIMB_DOWN_Y, 70}, {135, LIMB_DOWN_Y, 0}, {115, LIMB_DOWN_Y, -70}},
            .motion_time = MTIME_MID_VALUE, .time_stop = MTIME_MAX_VALUE, .time_update = MTIME_NO_UPDATE, .speed = 15
        },
        ...
        //
        {
            ...
            {{-115, LIMB_DOWN_Y, 70}, {-135, LIMB_DOWN_Y, 0}, {-115, LIMB_DOWN_Y, -70}, {115, LIMB_DOWN_Y, 70}, {135, LIMB_DOWN_Y, 0}, {115, LIMB_DOWN_Y, -70}},
            .motion_time = MTIME_MIN_VALUE, .time_stop = MTIME_MAX_VALUE, .time_update = MTIME_NO_UPDATE, .speed = 15
        },
        {
            {0}, // Destination points is not use for TRAJ_XZ_ADV_Y_CONST
            { TRAJ_XZ_ADV_Y_CONST, TRAJ_XZ_ADV_Y_CONST, TRAJ_XZ_ADV_Y_CONST, TRAJ_XZ_ADV_Y_CONST, TRAJ_XZ_ADV_Y_CONST, TRAJ_XZ_ADV_Y_CONST},
        ...
        //
        {
            ...
            { TIME_DIR_REVERSE, TIME_DIR_REVERSE, TIME_DIR_REVERSE, TIME_DIR_REVERSE, TIME_DIR_REVERSE, TIME_DIR_REVERSE },
            {{-115, LIMB_DOWN_Y, 70}, {-135, LIMB_DOWN_Y, 0}, {-115, LIMB_DOWN_Y, -70}, {115, LIMB_DOWN_Y, 70}, {135, LIMB_DOWN_Y, 0}, {115, LIMB_DOWN_Y, -70}},
            .motion_time = MTIME_MIN_VALUE, .time_stop = MTIME_MID_VALUE, .time_update = MTIME_NO_UPDATE, .speed = 15
        }
    }
};
...
static const sequence_info_t sequence_attack_left = {
    ...
    
    {
        ...
        //
        {
            ...
            { TRAJ_XYZ_LINEAR, TRAJ_XYZ_LINEAR, TRAJ_XYZ_LINEAR, TRAJ_XYZ_LINEAR, TRAJ_XYZ_LINEAR, TRAJ_XYZ_LINEAR},
            { TIME_DIR_DIRECT, TIME_DIR_DIRECT, TIME_DIR_DIRECT, TIME_DIR_DIRECT, TIME_DIR_DIRECT, TIME_DIR_DIRECT },
            .motion_time = MTIME_MIN_VALUE, .time_stop = MTIME_MAX_VALUE, .time_update = MTIME_NO_UPDATE, .speed = 50
        },
        {
            {{0, 0, 150}, {-135, LIMB_DOWN_Y, 0}, {-115, LIMB_DOWN_Y, -70}, {115, LIMB_DOWN_Y, 70}, {135, LIMB_DOWN_Y, 0}, {115, LIMB_DOWN_Y, -70}},
            { TRAJ_XYZ_LINEAR, TRAJ_XYZ_LINEAR, TRAJ_XYZ_LINEAR, TRAJ_XYZ_LINEAR, TRAJ_XYZ_LINEAR, TRAJ_XYZ_LINEAR},
...
static const sequence_info_t sequence_rotate_x = {
    ...
    
    {
        ...
        //
        {
            ...
            { TRAJ_XYZ_LINEAR, TRAJ_XYZ_LINEAR, TRAJ_XYZ_LINEAR, TRAJ_XYZ_LINEAR, TRAJ_XYZ_LINEAR, TRAJ_XYZ_LINEAR},
            { TIME_DIR_DIRECT, TIME_DIR_DIRECT, TIME_DIR_DIRECT, TIME_DIR_DIRECT, TIME_DIR_DIRECT, TIME_DIR_DIRECT },
            .motion_time = MTIME_MIN_VALUE, .time_stop = MTIME_MAX_VALUE, .time_update = MTIME_NO_UPDATE, .speed = 30
        },
        {
            {{-115, LIMB_DOWN_Y - LIMB_Y_OFFSET, 70}, {-135, LIMB_DOWN_Y, 0}, {-115, LIMB_DOWN_Y + LIMB_Y_OFFSET, -70}, {115, LIMB_DOWN_Y - LIMB_Y_OFFSET, 70}, {135, LIMB_DOWN_Y, 0}, {115, LIMB_DOWN_Y + LIMB_Y_OFFSET, -70}},
            { TRAJ_XYZ_LINEAR, TRAJ_XYZ_LINEAR, TRAJ_XYZ_LINEAR, TRAJ_XYZ_LINEAR, TRAJ_XYZ_LINEAR, TRAJ_XYZ_LINEAR},
