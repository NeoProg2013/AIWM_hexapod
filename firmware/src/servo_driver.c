...
bool servo_driver_cli_command_process(const char* cmd, const char (*argv)[CLI_ARG_MAX_SIZE], uint32_t argc, char* response) {
    ...
    else if (strcmp(cmd, "set_override_value") == 0 && argc == 2) {
